    ...
    services.factory('StatisticService', function ($http, ipCookie) {
        return{
            getStatistic4:function(){
                return $http.get('http://www.ecomap.org/api/getStats4');

            },
            getStatistic3:function(){
                return $http.get('http://www.ecomap.org/api/getStats3');
            ...
            getChart:function(val){
                ...
                var color = ["#f00", "", "#00f"]
                d3.xhr('http://www.ecomap.org/api/getStats1')
...
// is there a better way to do a bunch of lines as a single path with d3?
            ...
            getPie:function(val){
                ...
                d3.xhr('http://www.ecomap.org/api/getStats2/'+val)
                    .get(function(error, data) {
                        if (error) throw error;
